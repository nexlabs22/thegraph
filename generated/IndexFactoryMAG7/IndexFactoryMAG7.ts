...
export class TestIndexFactory__actionInfoByIdResult {
  value0: BigInt;
  value1: BigInt;
...
export class TestIndexFactory__getOrderInstanceByIdResultValue0Struct extends ethereum.Tuple {
...
export class TestIndexFactory__orderInstanceByIdResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class TestIndexFactory extends ethereum.SmartContract {
  static bind(address: Address): TestIndexFactory {
    return new TestIndexFactory("TestIndexFactory", address);
  }

  actionInfoById(param0: BigInt): TestIndexFactory__actionInfoByIdResult {
    ...
    return new TestIndexFactory__actionInfoByIdResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_actionInfoById(
    param0: BigInt,
  ): ethereum.CallResult<TestIndexFactory__actionInfoByIdResult> {
    ...
    return ethereum.CallResult.fromValue(
      new TestIndexFactory__actionInfoByIdResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  getOrderInstanceById(
    id: BigInt,
  ): TestIndexFactory__getOrderInstanceByIdResultValue0Struct {
    let result = super.call(
      "getOrderInstanceById",
    ...
    return changetype<TestIndexFactory__getOrderInstanceByIdResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getOrderInstanceById(
    id: BigInt,
  ): ethereum.CallResult<TestIndexFactory__getOrderInstanceByIdResultValue0Struct> {
    let result = super.tryCall(
      "getOrderInstanceById",
      "getOrderInstanceById(uint256):((uint64,address,address,address,bool,uint8,uint256,uint256,uint256,uint8))",
      [ethereum.Value.fromUnsignedBigInt(id)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<TestIndexFactory__getOrderInstanceByIdResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  orderInstanceById(param0: BigInt): TestIndexFactory__orderInstanceByIdResult {
    let result = super.call(
      "orderInstanceById",
    ...
    return new TestIndexFactory__orderInstanceByIdResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_orderInstanceById(
    param0: BigInt,
  ): ethereum.CallResult<TestIndexFactory__orderInstanceByIdResult> {
    let result = super.tryCall(
      "orderInstanceById",
      "orderInstanceById(uint256):(uint64,address,address,address,bool,uint8,uint256,uint256,uint256,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new TestIndexFactory__orderInstanceByIdResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toAddress(),
