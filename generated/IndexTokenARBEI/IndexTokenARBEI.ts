...
export class IndexTokenARBEI extends ethereum.SmartContract {
  static bind(address: Address): IndexTokenARBEI {
    return new IndexTokenARBEI("IndexTokenARBEI", address);
  }
  ...
  tokenMarketShare(param0: Address): BigInt {
    let result = super.call(
      "tokenMarketShare",
      "tokenMarketShare(address):(uint256)",
      [ethereum.Value.fromAddress(param0)],
    );
  ...
  try_tokenMarketShare(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "tokenMarketShare",
      "tokenMarketShare(address):(uint256)",
      [ethereum.Value.fromAddress(param0)],
