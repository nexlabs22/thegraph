...
export class IndexFactoryANFI extends ethereum.SmartContract {
  static bind(address: Address): IndexFactoryANFI {
    return new IndexFactoryANFI("IndexFactoryANFI", address);
  }
