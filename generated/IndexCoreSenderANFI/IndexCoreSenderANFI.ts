...
export class IndexCoreSenderANFI extends ethereum.SmartContract {
  static bind(address: Address): IndexCoreSenderANFI {
    return new IndexCoreSenderANFI("IndexCoreSenderANFI", address);
  }
